...
The website is generated using [Material for MkDocs](https://squidfunk.github.io/mkdocs-material) and can be viewed at [homelab.serendipity-work.com](https://homelab.serendipity-work.com).
...
<!-- - Find the TXT record for `homelab.serendipity-work.com` and switch the `ownerID` between `homelab` and `horus` -->
